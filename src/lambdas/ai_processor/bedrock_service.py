...
class BedrockService:
    ...
    def get_response_schema(self) -> dict:
        return {
            ...
            "properties": {
                "execution_id": {
                    "type": "string",
                    "description": "Unique identifier for this analysis execution.",
                },
                "analysis_date": {
                    "type": "string",
                    "description": "Date and time of the analysis in ISO 8601 format.",
                },
                "processing_status": {
                    "type": "string",
                    "description": "Status of the analysis (e.g., ANALYZED, FAILED).",
                },
                "technical_analysis": {
                    "type": "object",
                    "properties": {
                        "architecture_summary": {
                            ...
                            "properties": {
                                "description": {
                                    "type": "string",
                                    "description": "A high-level description of the architecture.",
                                },
                                "architectural_style": {
                                    "type": "string",
                                    "description": "Identified architectural style (e.g., Serverless, Microservices).",
                                },
                                "cloud_provider": {
                                    "type": "string",
                                    "description": "The cloud provider used (e.g., AWS, Azure, GCP).",
                                },
                            },
                            "required": [
                                "description",
                        ...
                        "service_inventory": {
                            ...
                            "items": {
                                ...
                                "properties": {
                                    ...
                                    "category": {
                                        "type": "string",
                                        "description": "Category of the service (e.g., Compute, Database, Networking).",
                                    },
                                    "quantity": {
                                        "type": "number",
                                        "description": "Number of instances or occurrences of this service.",
                                    },
                                },
                        ...
                        "architecture_findings": {
                            ...
                            "items": {
                                ...
                                "properties": {
                                    "type": {
                                        "type": "string",
                                        "description": "Type of finding (e.g., Security, Bottleneck, Cost, Scalability).",
                                    },
                                    "description": {
                                        "type": "string",
                                    ...
                                    "criticality": {
                                        "type": "string",
                                        "description": "Criticality level (e.g., High, Medium, Low).",
                                    },
                                },
    ...
    def process_image(self, process_image_dto: ProcessImageAIDTO) -> Dict[str, Any]:
        ...
        prompt_text = self.get_prompt_text(user_context=process_image_dto.prompt)
    ...
    def _build_request(
        self, image_bytes: bytes, media_type: str, prompt_text: str
    ) -> Dict[str, Any]:
